...
import { 
  Dashboard as DashboardView, Landing as LandingView, UserList as UserListView, NotFound as NotFoundView,
...
const Routes = () => {
  return (
    <Switch>
      ...
      <RouteWithLayout component={LandingView} exact layout={MinimalLayout} path="/" />
