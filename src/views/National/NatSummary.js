...
const Dashboard = props => {
  ...
  "Artesunate Injection", "Sulphadoxine Pyrimethamine Tabs", "Rapid Diagnostic Tests"];
   ...
   let summ_url_facility = filterUrlConstructor(filter_params.pe, filter_params.ou, filter_params.level, "http://0.0.0.0:3000/api/national/summary/facility-mos")
   let summ_url_kemsa = filterUrlConstructor(filter_params.pe, filter_params.ou, filter_params.level, "http://0.0.0.0:3000/api/national/summary/kemsa-mos")
   let summ_url_pending = filterUrlConstructor(filter_params.pe, filter_params.ou, filter_params.level, "http://0.0.0.0:3000/api/national/summary/pending-mos")
   let kemsa_url = filterUrlConstructor(filter_params.pe, filter_params.ou, filter_params.level, "http://0.0.0.0:3000/api/national/summary/kemsasummary")
  ...
  const onUrlChange = () => {
    props.history.listen( (location, action) => {
      ...
      let new_summ_url_facility = filterUrlConstructor(new_filter_params.pe, new_filter_params.ou, new_filter_params.level, "http://0.0.0.0:3000/api/national/summary/facility-mos")
      let new_summ_url_kemsa = filterUrlConstructor(new_filter_params.pe, new_filter_params.ou, new_filter_params.level, "http://0.0.0.0:3000/api/national/summary/kemsa-mos")
      let new_summ_url_pending = filterUrlConstructor(new_filter_params.pe, new_filter_params.ou, new_filter_params.level, "http://0.0.0.0:3000/api/national/summary/pending-mos")
      fetchMOSsummary(new_summ_url_facility, new_summ_url_kemsa, new_summ_url_pending)

      let new_kemsa_url = filterUrlConstructor(new_filter_params.pe, new_filter_params.ou, new_filter_params.level, "http://0.0.0.0:3000/api/national/summary/kemsasummary")
